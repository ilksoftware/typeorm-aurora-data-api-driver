...
var ApplyValueTransformers_1 = require("typeorm/util/ApplyValueTransformers");
...
var MysqlQueryTransformer = /** @class */ (function (_super) {
    ...
    MysqlQueryTransformer.prototype.preparePersistentValue = function (value, metadata) {
        ...
        if (metadata.transformer) {
            value = ApplyValueTransformers_1.ApplyValueTransformers.transformTo(metadata.transformer, value);
        }
    ...
    MysqlQueryTransformer.prototype.prepareHydratedValue = function (value, metadata) {
        if (value === null || value === undefined) {
            return metadata.transformer
                ? ApplyValueTransformers_1.ApplyValueTransformers.transformFrom(metadata.transformer, value)
                : value;
        }
        switch (metadata.type) {
            case Boolean:
            ...
            case 'set':
            case 'simple-array':
                value = typeof value === 'string' ? (0, transform_utils_1.stringToSimpleArray)(value) : value;
                break;
            case 'json':
            case 'simple-json':
        ...
        if (metadata.transformer)
            value = ApplyValueTransformers_1.ApplyValueTransformers.transformFrom(metadata.transformer, value);
        return value;
    };
